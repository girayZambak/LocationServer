...
public class GetFollowingEmergencyPersonsServiceResponse extends BaseServiceResponse {
    ...
    public static class GetFollowingEmergencyPersonsServiceResponseBuilder extends BaseServiceResponseBuilder<GetFollowingEmergencyPersonsServiceResponse> {
        public GetFollowingEmergencyPersonsServiceResponse buildServiceResponse(List<EmergencyPersonDRO> emergencyPersonDROList) {
